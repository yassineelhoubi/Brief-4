...
<body>
	...
	<main>
		<div class="placeholder">
			...
			<div class="featlink">
				<a href="#1">
					<img href="#1" alt="" src="./src/img/featicons/1.png">
					<h3>Pre-admission</br>Features</h3>
				</a>
			</div>
			
			<div class="featlink">
				<a href="#2">			
					<img href="#2" alt="" src="./src/img/featicons/2.png">
					<h3>CRM</br>Features</h3>
				</a>
			</div>

			<div class="featlink">
				<a href="#3">
					<img href="#3" alt="" src="./src/img/featicons/3.png">
					<h3>SIS</br>Features</h3>
				</a>
			</div>

			<div class="featlink">
				<a href="#4">
					<img href="#4" alt="" src="./src/img/featicons/4.png">
					<h3>LMS</br>Features</h3>
				</a>
			</div>

			<div class="featlink">
				<a href="#5">
					<img href="#5" alt="" src="./src/img/featicons/5.png">
					<h3>Add-On</br>Features</h3>
				</a>
			</div>
		...
		<div class="features">
			...
			<div class="feature" id="1">
				<h3>Pre-admission Features</h3>
				<div class="descs">
					<h4>Lorem Ipsum</h4>
					<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure ipsam repellat animi assumenda
						soluta saepe?</p>
					<h4>Lorem Ipsum</h4>
					<p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nesciunt ipsa vero explicabo, maxime
						fugit nostrum.</p>
					<h4>Lorem Ipsum</h4>
					<p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nesciunt ipsa vero explicabo, maxime
						fugit nostrum.</p>
			...
			<div class="feature" id="4">
				...
				<img src="src/img/feat4.svg" alt="">
			</div>
			<div class="feature" id="5">
				<h3>Add-Ons</h3>
				<div class="descs">
					<h4>Lorem Ipsum</h4>
					<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure ipsam repellat animi assumenda
